...
# -*- coding: utf-8 -*-
#
# hsgame documentation build configuration file, created by
...
html_title = "Hearthstone Simulator"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "HS Sim"
...
latex_documents = [
    ('index', 'hsgame.tex', 'hsgame Documentation',
     'Daniel Yule', 'manual'),
]
...
man_pages = [
    ('index', 'hsgame', 'hsgame Documentation',
     ['Daniel Yule'], 1)
]
...
texinfo_documents = [
    ('index', 'hsgame', 'hsgame Documentation',
     'Daniel Yule', 'hsgame', 'One line description of project.',
     'Miscellaneous'),
]
...
epub_title = 'hsgame'
epub_author = 'Daniel Yule'
epub_publisher = 'Daniel Yule'
epub_copyright = '2014, Daniel Yule'

# The basename for the epub file. It defaults to the project name.
#epub_basename = 'hsgame'
